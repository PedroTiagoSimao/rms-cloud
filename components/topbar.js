...
const Topbar = () => {
    ...
    const toggleUsermenu = () => {
        ...
        showUsermenu ? null : setShowAlertmenu(false)
    }

    const toggleAlertmenu = () => {
        setShowAlertmenu(current => !current)
        showAlertmenu ? null : setShowUsermenu(false)
    }
    ...
    <header className="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
        ...
        <ul className="flex items-center flex-shrink-0 space-x-6">
            ...
            >
                ...
                <ul
                className={`absolute right-0 w-56 p-2 mt-2 space-y-2 text-gray-600 bg-white border border-gray-100 rounded-md shadow-md dark:text-gray-300 dark:border-gray-700 dark:bg-gray-700 ${showAlertmenu ? '' : 'hidden'}`}
                aria-label="submenu"
                >
                <li className="flex">
                    <a
            ...
            >
                ...
                <ul
                className={`absolute right-0 w-56 p-2 mt-2 space-y-2 text-gray-600 bg-white border border-gray-100 rounded-md shadow-md dark:border-gray-700 dark:text-gray-300 dark:bg-gray-700 ${showUsermenu ? '' : 'hidden'}`}
                aria-label="submenu"
                >
                <li className="flex">
                    <a
